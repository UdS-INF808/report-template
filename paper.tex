...
\section{Inclure une image}

Un portrait de Donald Knuth nous est fourni par la Figure~\ref{fig:dk}, la photo est prise sous le format JPG. 
%Il est également possible insérer des fichier SVG comme pour la machine Enigma représentée à la figure~\ref{fig:enigma}   

\begin{figure}[H]
	\includegraphics[width=0.5\columnwidth]{./fig/Donald_Ervin_Knuth.jpg}
  \caption{Donald Knuth}
  \label{fig:dk}
\end{figure}

%\begin{figure}{H}
%  \includesvg{./fig/File_Enigma-action.svg}
%  \caption{Enigma}
%  \label{fig:enigma}
%\end{figure}
